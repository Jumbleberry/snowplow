...
users as (
    ...
    select
        ...
        date_part('year', cast(b.first_session_start as date)) as first_session_year,
        ...
        date_part('hour', cast(b.first_session_start_local as date)) as first_session_local_hour_of_day,
