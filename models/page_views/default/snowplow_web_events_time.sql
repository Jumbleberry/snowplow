...
prep as (
    ...
    select
        ...
        least(min({{snowplow_timestamp_ntz('ev.collector_tstamp')}}), min({{snowplow_timestamp_ntz('ev.derived_tstamp')}})) as min_tstamp,
        least(max({{snowplow_timestamp_ntz('ev.collector_tstamp')}}), max({{snowplow_timestamp_ntz('ev.derived_tstamp')}})) as max_tstamp,
